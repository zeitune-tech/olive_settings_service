...
@RestController
@RequestMapping("/inter-services/settings/qualites")
@RequiredArgsConstructor
public class QualityInterServiceController {
    ...
    public ResponseEntity<PageResponse<QualityResponse>> list(
        ...
        Page<QualityResponse> page = service.listInterService(q, pageable);
