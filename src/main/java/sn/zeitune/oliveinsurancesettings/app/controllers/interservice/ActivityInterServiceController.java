...
@RestController
@RequestMapping("/inter-services/settings/activites")
@RequiredArgsConstructor
public class ActivityInterServiceController {
    ...
    public ResponseEntity<PageResponse<ActivityResponse>> list(
        ...
        Page<ActivityResponse> page = service.listInterService(q, pageable);
